...
export const setUserData = user => async (dispatch, getState) => {
	...
	if(user.data.role == 'alumno' || user.data.role == 'alumno_secundaria' || user.data.role == 'profesor_summit_2021' || user.data.role == 'alumnoe0' || user.data.role == 'maestro_preescolar' || user.data.role == 'maestro_secundaria' || user.data.role == 'maestro' || user.data.role == 'preescolar' || user.data.role == 'padre' ){
