...
function LoginLia() {
	...
	return (
		<div
		className={clsx((userType == "admin" || userType == "alumno" || userType == "alumno_secundaria" || userType == "preescolar") ? classes.root_alumnos : (userType == "maestro" || userType == "maestro_preescolar" || userType == "maestro_secundaria") ? classes.root_maestros : userType === "padre" ? classes.root_padres :classes.root_escuelas,
			'flex flex-col flex-auto items-center justify-center flex-shrink-0 p-16 md:p-24'
		)}
	>
		<div className={clsx((userType == "admin" || userType == "alumno" || userType == "alumno_secundaria" || userType == "preescolar") ? classes.image_overlay_alumnos : (userType == "maestro" || userType == "maestro_preescolar" || userType == "maestro_secundaria") ? classes.image_overlay_maestros : userType === "padre" ? classes.image_overlay_padres :classes.image_overlay_escuelas)}/>
