...
export const getSubjects = createAsyncThunk('subjectsApp/subjects/getSubjects', async (params) => {
...
const subjectSlice = createSlice({
	...
	extraReducers: {
		// [updateContact.fulfilled]: subjectsAdapter.upsertOne,
		// [addContact.fulfilled]: subjectsAdapter.addOne,
